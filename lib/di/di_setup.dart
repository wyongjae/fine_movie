...
import 'package:fine_movie/data/repository/movie/movie_credits_repository_impl.dart';
import 'package:fine_movie/data/repository/movie/movie_data_repository_impl.dart';
import 'package:fine_movie/data/repository/movie/movie_detail_repository_impl.dart';
import 'package:fine_movie/data/repository/movie/movie_genre_repository_impl.dart';
import 'package:fine_movie/data/repository/movie/movie_video_repository_impl.dart';
...
import 'package:fine_movie/domain/use_case/get_movie_with_query_use_case.dart';
...
void diSetup() {
  ...
  getIt.registerLazySingleton<UseCases>(
    () => UseCases(
      ...
      genreUseCase: GetMovieGenreUseCase(
          getIt<MovieDataRepository<List<Genre>, Param>>()),
      ...
      movieWithQueryUseCase: GetMovieWithQueryUseCase(
          getIt<MovieDataRepository<List<Movie>, Param>>()),
    ),
  );
  ...
  getIt.registerFactory<MovieSearchScreenViewModel>(
      () => MovieSearchScreenViewModel(getIt<UseCases>()));

  getIt.registerFactory<MyScreenViewModel>(
      () => MyScreenViewModel(getIt<UseCases>()));
}
